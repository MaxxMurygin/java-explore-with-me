...
(
    ...
    CONSTRAINT unique_compilation_name unique (title)
);
...
(
    ...
    CONSTRAINT fk_comments_users FOREIGN KEY (author_id)
        ...
        ON UPDATE CASCADE
        ON DELETE CASCADE,
    CONSTRAINT uq_user_event UNIQUE (event_id, author_id)
);
...
(
    ...
    CONSTRAINT fk_complaints_comments FOREIGN KEY (comment_id)
        ...
        ON UPDATE CASCADE
        ON DELETE CASCADE,
    CONSTRAINT fk_complaints_users FOREIGN KEY (complainant_id)
        REFERENCES users (id)
        ON UPDATE CASCADE
        ON DELETE CASCADE,
    CONSTRAINT uq_user_comment UNIQUE (comment_id, complainant_id)
);